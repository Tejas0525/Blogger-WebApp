...
export default function CreatePost() {
  ...
  async function createNewPost(ev) {
    ...
    if (summary.trim().length < 20 || summary.trim().length < 240) {
      setSummaryError("Summary must be between 20 and 240 characters.");
      hasError = true;
    }

    if (content.trim().length < 500) {
      setContentError("Content must be at least 500 characters long.");
      hasError = true;
    }
